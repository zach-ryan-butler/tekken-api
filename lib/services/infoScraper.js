        ...
        return request
          ...
          .then(html => {
            ...
            $('.pi-item.pi-data.pi-item-spacing.pi-border-color').each((i, el) => {
              ...
              if(element.children('h3').text() === 'Likes') {
                characterObj['likes'] = element.children('div').contents().text();
              } 
              if(element.children('h3').text() === 'Fighting Style') {
                characterObj['fightingStyle'] = element.children('div').contents().text();
              } 
              if(element.children('h3').text() === 'Dislikes') {
                characterObj['dislikes'] = element.children('div').contents().text();
              } 
